...
- **Dataset:** Public Dataset [iSign](https://huggingface.co/datasets/Exploration-Lab/iSign) (118,000 video-sentence pairs) , Task validation and Test dataset [Translation Dataset](https://huggingface.co/datasets/Exploration-Lab/WSLP-AACL-2026/tree/main/Shared_task_MT) 
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '1.5rem' }}>
  <a href="https://huggingface.co/datasets/Exploration-Lab/WSLP-AACL-2026/tree/main/Shared_task_MT" target="_blank" style={{ padding: '8px 16px', backgroundColor: 'white', color: '#0a0a0a', textDecoration: 'none', borderRadius: '4px', fontSize: '0.9rem', border: '1px solid #0a0a0a', transition: 'all 0.2s ease' }}>
    Dataset
  </a>
...
- **Dataset:** Dataset  [word Recognition Dataset](https://huggingface.co/datasets/Exploration-Lab/WSLP-AACL-2026/tree/main/Shared_task_WR)
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '1.5rem' }}>
  <a href="https://huggingface.co/datasets/Exploration-Lab/WSLP-AACL-2026/tree/main/Shared_task_WR" target="_blank" style={{ padding: '8px 16px', backgroundColor: 'white', color: '#0a0a0a', textDecoration: 'none', borderRadius: '4px', fontSize: '0.9rem', border: '1px solid #0a0a0a', transition: 'all 0.2s ease' }}>
    Dataset
  </a>
...
- **Dataset:** [Word Presence Dataset](https://huggingface.co/datasets/Exploration-Lab/WSLP-AACL-2026/tree/main/Shared_task_WPP)
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '10px', marginTop: '1.5rem' }}>
  <a href="https://huggingface.co/datasets/Exploration-Lab/WSLP-AACL-2026/tree/main/Shared_task_WPP" target="_blank" style={{ padding: '8px 16px', backgroundColor: 'white', color: '#0a0a0a', textDecoration: 'none', borderRadius: '4px', fontSize: '0.9rem', border: '1px solid #0a0a0a', transition: 'all 0.2s ease' }}>
...
| 📚 Proceedings Due          | October 20th, 2026              |
